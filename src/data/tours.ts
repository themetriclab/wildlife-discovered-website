...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    seoDescription: "Ground-level polar bear photography tours in Churchill. Group of 5, licensed Arctic guide. Bears, arctic fox, snowy owls and northern lights.",
