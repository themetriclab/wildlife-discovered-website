...
const rawTours: Tour[] = [
  ...
  },
  {
    ...
    whatToExpectItems: [
      { title: "Arrival & Lodge", icon: "Plane", content: "Fly from Winnipeg to Churchill, Manitoba. Your guide meets you at the airport and transfers you to a private lodge where every room has a private 3-piece bath, refrigerator, and individual thermostat. A communal kitchen and common room make it easy to gather, review images, and warm up between sessions." },
      { title: "Daily Rhythm", icon: "Sunrise", content: "Each day begins with a continental breakfast before heading out at first light. You'll take a short lunch break in the field, then continue photographing through the best afternoon light. Evenings are spent at Churchill's restaurants, with northern lights photography possible when skies are clear." },
      { title: "Ground-Level Photography", icon: "Camera", content: "Unlike tundra buggy tours, you'll be on the ground at eye level with polar bears. Our 4×4 van has a door for each photographer, allowing quick exits for fast-moving foxes or bears and rapid re-entry if an animal approaches." },
      { title: "Guide-Led Positioning", icon: "Compass", content: "Your licensed Manitoba guide uses 15 years of polar bear field experience to read bear patterns and behaviour, positioning the group safely for the strongest compositions, backgrounds, and Arctic light." },
      { title: "Ethical Viewing", icon: "ShieldCheck", content: "Polar bears are a protected species and Churchill is their home. Every expedition follows strict Manitoba WMA protocols. We never bait, call in, or pressure animals for a photo — ethical viewing produces stronger images and a healthier population for future photographers." },
    ],
